	...
	<div class="container">
		<h2 class="letraNegra">
           ...
           color: white; }
			...
			<a href="actoresInhabilitados.php" class="btn btn--5">Actores inhabilitadas</a>
			<br>
			<br>
			</center>
		</h2>
		...
		<table class="table table-light table-striped table-hover">
		  <thead>
			...
			<th class="bg-warning text-white" scope="col">Inhabilitar Actor</th>
			<th class="bg-info text-white" scope="col">Borrado Fisico</th>
		    </tr>
		  </thead>
		  <tbody>
			<?PHP

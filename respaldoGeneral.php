...
<body>
	...
	<div class="container">
		<h1 class="letraBlanca">Estatus:</h1>
		...
		<?php 
				...
				define("BACKUP_DIR", 'respaldos'); // Comment this line to use same script's directory ('.')
				...
				class Backup_Database {
				    ...
				    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
				        ...
				        $this->backupFile              = 'respaldoBD-'.$this->dbName.'-'.date("dmY_His", time()).'.sql';
				...
				if (php_sapi_name() != "cli") {
				    echo '<div style="font-family: monospace; color:white;">';
				}
				...
				?>
		<hr>
		<h1 class="letraBlanca">Respaldo correcto</h1>
		<hr>

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2022 a las 03:54:04
...
(2, 'Christian Bale', 'Antártida', 0),
(3, 'Edward John David Redmayne', 'Argentina', 0),
...
(21, 'Kevin Director2', '2022-07-13', 'México', 0);
...
(1, 'Lego Batman 2', '0000-00-00', 'USA', 'Ingles', 'color', 'PG-13', '2007-05-16', 'Batichica se une a los cruzados impedir que Señor Frio  terrible venganza					', 0),
...
(27, 'Película 12 Julio', '2022-07-12', 'Mexicana', 'Español', 'Blanco y Negro', 'vbvb', '2022-07-13', 'Esta es una prueba', 1);
...
(3, 'Kevin', 'KEVIN@GMAIL.COM', 'KEVOEMM', '12345');
...
--
ALTER TABLE `director`
  MODIFY `idDirector` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

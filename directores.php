  ...
  ?>
	...
	<div class="container">
		...
		<?PHP 
			...
			$consulta = "SELECT * FROM director  WHERE estatus=1";
		  ...
		  <tbody>
			...
			while($row = $resultado->fetch_assoc()){
			    ...
			    <tr>
			      ...
			      <td>
				  <a href="borrarLogicoDirectores.php?id=<?php echo $row['idDirector'];?>">
			      ...
			      <td>
				  <a href="borrarFisicoDirectores.php?id=<?php echo $row['idDirector'];?>">
